...
def report_work(
    ...
    with sync_playwright() as playwright_context:
        ...
        try:
            logging.info(f"Navigating to login page: {TOMHRM_LOGIN_URL}")
            ...
            logging.info("Waiting for bulk add form to appear...")
            ...
            logging.info(f"Looking for entry for date: {date_today_str}")
...
def main() -> None:
    ...
    logging.info(f"Screenshots will be saved to: {screenshot_dir.resolve()}")
